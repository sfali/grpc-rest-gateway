  ...
  def apply(options: GeneratorOption*): (SandboxedJvmGenerator, Seq[String]) =
    (
      SandboxedJvmGenerator.forModule(
        ...
        "com.improving.grpc_rest_gateway.compiler.AkkaGatewayGenerator$",
        com.improving.grpc_rest_gateway.compiler.AkkaGatewayGenerator.suggestedDependencies
      ),
