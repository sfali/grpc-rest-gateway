...
Compile / PB.targets := Seq(
  ...
  grpc_rest_gateway.openApiGen(version = "1.0.0") -> (Compile / resourceManaged).value / "specs"
)
...
Compile / PB.targets := Seq(
  ...
  grpc_rest_gateway.openApiGen(version = "2.0.0") -> (Compile / resourceManaged).value / "openapi-specs"
)
