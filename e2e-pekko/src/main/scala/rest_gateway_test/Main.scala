...
import rest_gateway_test.api.scala_api.{TestServiceAGatewayHandler, TestServiceBGatewayHandler}
...
object Main {
  ...
  def main(args: Array[String]): Unit = {
    ...
    new HttpServer().run("0.0.0.0", 7070, TestServiceAGatewayHandler(settings), TestServiceBGatewayHandler(settings))
